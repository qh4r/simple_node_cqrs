...
export class UsersAndTransactions1583278213444 implements MigrationInterface {
    name = 'UsersAndTransactions1583278213444'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "transaction" ("id" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "operation" "transaction_operation_enum" NOT NULL, "ownerId" uuid, "targetId" uuid, "amount" integer NOT NULL, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`, undefined);
